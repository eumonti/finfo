/*
  ...
  una direttiva #define).Nota: C = 2 * PI * r,  A = PI * r^2  se  r, C ed A sono rispettivamente
  raggio, circonferenza e area del cerchio
  Esempio di esecuzione (in rosso i dati inseriti dall'utente):
